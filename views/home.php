			...
			<thead class="thead-dark ">
				...
				<tr>
					<div class="row row-cols-2">
						<th scope="col-md-1"> Numero Cadastro</th>
						<th scope="col-md-1"> Nome Usuário</th>
						<th scope="col-md-1"> E-mail Cadastrado </th>
						<th scope="col-md-1"> Anotações </th>
						<th scope="col-md-1"> Editar Usuário </th>
						<th scope="col-md-1"> Excluir Usuário</th>
					</div>
				</tr>
